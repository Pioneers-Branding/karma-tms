        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              How TMS Therapy Helps Veterans Heal: A New Hope for PTSD,
              Depression & Anxiety
            </h1>
            <p className="text-xl md:text-2xl text-white/90 mb-8">
              Discover how Transcranial Magnetic Stimulation offers veterans a
              breakthrough treatment for service-related mental health
              conditions
            </p>
          ...
          <article className="lg:col-span-3 prose prose-lg max-w-none">
            ...
            <div className="mb-12">
              ...
              <p className="text-xl text-gray-700 leading-relaxed">
                ...
                options when dealing with combat-related PTSD, depression, and
                anxiety. Traditional treatments don't work for everyone, and
                many veterans experience debilitating side effects from
                medications. But there's new hope:{" "}
                <strong>TMS therapy for veterans</strong> is emerging as a
                game-changing treatment that's helping thousands of service
            ...
            <section
              ...
              <Card className="bg-gradient-to-br from-[#572670]/5 to-transparent border-[#572670]/20 mb-6">
                <CardContent className="p-6">
                  <p className="text-lg font-medium text-[#572670] mb-2">
                    Quick Definition
                  </p>
                  <p className="text-gray-700">
                    Transcranial Magnetic Stimulation (TMS) is an FDA-approved,
                    non-invasive treatment that uses magnetic pulses to
                    stimulate specific areas of the brain associated with mood
              ...
              <p className="mb-4">
                Unlike traditional treatments that rely on medications affecting
                your entire body,{" "}
                <Link
                  to="/tms-therapy"
                ...
                anxiety, and PTSD symptoms. This precision approach makes it
                particularly effective for veterans whose mental health
                conditions stem from specific traumatic experiences.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 my-6">
                ...
                <Card className="border-[#572670]/20">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-gray-600">
                      No medications, no chemical dependencies
                    </p>
                  </CardContent>
                </Card>
                <Card className="border-[#572670]/20">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-gray-600">
                      Cleared for depression, anxiety, and OCD
                    </p>
                  </CardContent>
                </Card>
                <Card className="border-[#572670]/20">
            ...
            <section
              ...
              <p className="mb-6">
                Military service often involves exposure to traumatic events
                that can fundamentally alter brain function.{" "}
                <strong>TMS for veterans</strong> addresses these changes at the
                neurological level, helping restore normal brain activity
                patterns.
              </p>
              ...
              <p className="mb-4">
                ...
                Traditional therapy and medication help some, but many veterans
              ...
              <Card className="bg-blue-50 border-blue-200 mb-6">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700">
                    Studies show that TMS therapy can reduce PTSD symptoms by up
                    to 50% in veterans who haven't responded to traditional
                    treatments. The therapy specifically targets the prefrontal
                    cortex, helping regulate the overactive fear response common
                    in PTSD.
                  </p>
                </CardContent>
              </Card>
              ...
              <p className="mb-4">
                ...
                often co-occurring with PTSD.{" "}
                <strong>Veterans Administration TMS</strong> programs have shown
                remarkable success in treating treatment-resistant depression.
              </p>

              <p className="mb-6">TMS therapy helps veterans by:</p>
              <ul className="list-disc pl-6 mb-6 space-y-2">
                <li>
                  Activating dormant neural pathways in the prefrontal cortex
                </li>
                <li>
                  Increasing production of mood-regulating neurotransmitters
                </li>
                <li>
                  Reducing symptoms without the side effects of antidepressants
                </li>
                <li>
                  Providing lasting relief that continues after treatment ends
                </li>
              </ul>

              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                VA Anxiety Treatment
              </h3>
              <p className="mb-4">
                <Link
                  to="/anxiety"
                ...
                panic disorder, or service-related anxiety, TMS therapy offers
                relief by calming overactive brain regions responsible for the
                constant state of alarm many veterans experience.
              </p>
            </section>
            ...
            <section
              ...
              <p className="mb-6">
                The Department of Veterans Affairs recognizes the potential of
                TMS therapy and has been expanding access to this treatment
                across the country. Many <strong>VA hospital TMS</strong>{" "}
                programs now offer this service to eligible veterans.
              </p>

              <Card className="border-[#572670]/20 mb-6">
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold mb-4">
                    VA TMS Program Eligibility
                  </h3>
                  <p className="mb-4">
                    Veterans may qualify for VA-covered TMS therapy if they:
                  </p>
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" />
                      <span>
                        Have tried at least 2 different antidepressant
                        medications without adequate response
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle2 className="w-5 h-5 text-green-600 mt-1 flex-shrink-0" />
                      <span>
                        Receive approval from their VA psychiatrist or mental
                        health provider
                      </span>
                    </li>
                  </ul>
              ...
              <div className="bg-gradient-to-r from-[#572670]/10 to-transparent p-6 rounded-lg border-l-4 border-[#572670] mb-6">
                ...
                <p className="text-gray-700">
                  While VA facilities are expanding TMS services, wait times can
                  be significant. Many veterans choose to pursue treatment at
                  ...
                  flexible scheduling and often faster access to care.
                </p>
              </div>
            </section>
            ...
            <section
              ...
              <p className="mb-8">
                Real veterans are experiencing life-changing results with TMS
                therapy. While individual results vary, these stories illustrate
                    ...
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        <p className="font-bold">
                          Marine Corps Veteran, Age 34
                        </p>
                        <p className="text-sm text-gray-600">
                          Two combat deployments, 6 years of PTSD symptoms
                        </p>
                      </div>
                    </div>
                    <p className="text-gray-700 italic mb-3">
                      "After trying multiple medications and years of therapy, I
                      was losing hope. TMS therapy changed everything. Three
                      weeks into treatment, I started sleeping through the night
                      for the first time in years. By week six, my
                      hypervigilance had decreased dramatically, and I could
                      actually enjoy time with my family again."
                    </p>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Treatment-resistant depression for 8 years
                        </p>
                      </div>
                    </div>
                    <p className="text-gray-700 italic mb-3">
                      "Depression had taken everything from me—my career, my
                      relationships, my will to live. The VA tried different
                      medications, but the side effects were unbearable. TMS
                      gave me my life back without any of the side effects. I'm
                      working again, reconnecting with my kids, and actually
                      feel like myself for the first time since I left the
                      service."
                    </p>
                    <div className="flex gap-2 text-sm text-[#572670] font-medium">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Anxiety and panic attacks post-service
                        </p>
                      </div>
                    </div>
                    <p className="text-gray-700 italic mb-3">
                      "My anxiety was so severe I couldn't leave my house. Every
                      sound sent me into panic mode. TMS therapy helped calm the
                      constant state of alarm my brain was in. Now I can drive,
                      shop, and even attend my daughter's school events—things I
                      hadn't done in three years."
                    </p>
                    <div className="flex gap-2 text-sm text-[#572670] font-medium">
            ...
            <section
              ...
              <p className="mb-6">
                Understanding what to expect can help veterans feel more
                comfortable pursuing TMS therapy. Here's a step-by-step
                overview:
              </p>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Meet with a psychiatrist to review your medical
                          history, current symptoms, and treatment goals. We'll
                          assess whether you're a good candidate for TMS and
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Using advanced technology, we'll map your brain to
                          identify the precise treatment location and determine
                          the optimal magnetic pulse intensity for your unique
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Attend 5 sessions per week for 4-6 weeks. Each session
                          lasts 20-40 minutes. You'll sit comfortably while the
                          TMS device delivers magnetic pulses to your brain.
                          Most veterans describe a tapping sensation on the
                          scalp.
                        </p>
                      </div>
                    </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          Regular check-ins with your treatment team to assess
                          symptom improvement and adjust the protocol if needed.
                          Many veterans notice improvements within 2-3 weeks.
                        </p>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700">
                          After completing the treatment course, we'll develop a
                          maintenance plan. Some veterans benefit from periodic
                          booster sessions, while others maintain their
                          improvements without additional treatment.
                        </p>
                      </div>
                    </div>
                  </CardContent>
              ...
              <Card className="bg-gradient-to-br from-green-50 to-transparent border-green-200 mb-6">
                <CardContent className="p-6">
                  <p className="font-medium text-green-900 mb-2">
                    What Makes Treatment Veteran-Friendly?
                  </p>
                  <p className="text-gray-700">
                    At KarmaTMS, we understand the unique needs of veterans. Our
                    staff is trained in trauma-informed care, we offer flexible
                    scheduling to accommodate work and family commitments, and
                    we work with VA benefits and military insurance to make
            ...
            <Card className="bg-gradient-to-br from-[#572670] to-[#7B3FA0] text-white mb-12">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-lg mb-6 text-white/90">
                  Join the thousands of veterans who have found relief with TMS
                  therapy. Our team is ready to help you reclaim your life.
                </p>
