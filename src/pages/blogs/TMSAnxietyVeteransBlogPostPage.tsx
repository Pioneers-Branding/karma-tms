        ...
        <article className="container mx-auto px-4 pb-16">
          <div className="max-w-4xl mx-auto prose prose-lg">
            ...
            <section className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">Understanding Anxiety in Veterans</h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">Anxiety as a Standalone Disorder in Veterans</h2>
              <div className="bg-slate-50 rounded-xl p-6 md:p-8 mb-6">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-slate-900 mb-4">Common Anxiety Disorders in Veterans:</h3>
                <div className="space-y-3 md:space-y-4">
                  <div className="border-l-4 border-blue-500 pl-4 md:pl-6">
                    <h4 className="text-lg md:text-xl font-semibold text-slate-900 mb-2">Generalized Anxiety Disorder (GAD)</h4>
                    <p className="text-sm md:text-base text-slate-700">Persistent, excessive worry about various aspects of life including health, finances, work, and family.</p>
                  </div>
                  <div className="border-l-4 border-blue-500 pl-4 md:pl-6">
                    <h4 className="text-lg md:text-xl font-semibold text-slate-900 mb-2">Panic Disorder</h4>
                    <p className="text-sm md:text-base text-slate-700">Recurrent, unexpected panic attacks with intense physical symptoms and fear of future attacks.</p>
                  </div>
                  <div className="border-l-4 border-blue-500 pl-4 md:pl-6">
                    <h4 className="text-lg md:text-xl font-semibold text-slate-900 mb-2">Social Anxiety Disorder</h4>
                    <p className="text-sm md:text-base text-slate-700">Intense fear of social situations, particularly common during the transition from military to civilian life.</p>
                  </div>
                  <div className="border-l-4 border-blue-500 pl-4 md:pl-6">
                    <h4 className="text-lg md:text-xl font-semibold text-slate-900 mb-2">Specific Phobias</h4>
                    <p className="text-sm md:text-base text-slate-700">Intense fear of specific objects or situations, which may develop or worsen during service.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            {/* Signs and Symptoms */}
            <section className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">Recognizing Anxiety in Veterans</h2>
              <img
              ...
              <div className="grid sm:grid-cols-2 gap-4 md:gap-6 mb-6">
                <div className="bg-blue-50 rounded-xl p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold text-slate-900 mb-4">Physical Symptoms</h3>
                ...
                <div className="bg-purple-50 rounded-xl p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold text-slate-900 mb-4">Psychological Symptoms</h3>
                  <ul className="list-disc pl-5 md:pl-6 text-sm md:text-base text-slate-700 space-y-2">
            ...
            {/* VA Anxiety Support */}
            <section className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">VA Anxiety Support and Resources</h2>
              <p className="text-base md:text-lg text-slate-700 leading-relaxed mb-6">
              ...
              <div className="bg-green-50 border-l-4 border-green-500 p-4 md:p-6 rounded-lg mb-6">
                <h3 className="text-lg md:text-xl font-bold text-slate-900 mb-4">VA Benefits for Anxiety:</h3>
                <ul className="list-disc pl-5 md:pl-6 text-sm md:text-base text-slate-700 space-y-2">
            ...
            <section className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">How TMS Works for Anxiety</h2>
              <img
              ...
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-6 md:p-8 mb-6">
                <h3 className="text-xl md:text-2xl font-bold text-slate-900 mb-4">The Science Behind TMS for Anxiety</h3>
                <div className="space-y-4 md:space-y-6">
                  <div>
                    <h4 className="text-lg md:text-xl font-semibold text-slate-900 mb-3">Targeting Anxiety Centers</h4>
                    ...
                    <ul className="list-disc pl-5 md:pl-6 text-sm md:text-base text-slate-700 space-y-1">
                  ...
                  <div>
                    <h4 className="text-lg md:text-xl font-semibold text-slate-900 mb-3">Neuroplasticity and Healing</h4>
                  ...
                  <div>
                    <h4 className="text-lg md:text-xl font-semibold text-slate-900 mb-3">The Treatment Process</h4>
                    <ul className="list-disc pl-5 md:pl-6 text-sm md:text-base text-slate-700 space-y-2">
            ...
            <section className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">Brain Regulation Through TMS: Beyond Symptom Management</h2>
              <p className="text-base md:text-lg text-slate-700 leading-relaxed mb-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4 md:gap-6 mb-6">
                <div className="bg-slate-50 rounded-xl p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold text-slate-900 mb-4">Traditional Medication Approach</h3>
                ...
                <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-xl p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold text-slate-900 mb-4">TMS Approach</h3>
                  <ul className="space-y-2 md:space-y-3 text-sm md:text-base text-slate-700">
                    <li className="flex items-start gap-2">
            ...
            <section className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">Benefits of TMS for Veterans with Anxiety</h2>
              <div className="space-y-4 md:space-y-6">
                <div className="bg-blue-50 rounded-xl p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold text-slate-900 mb-3">1. No Systemic Side Effects</h3>
                  <p className="text-sm md:text-base text-slate-700">
                ...
                <div className="bg-purple-50 rounded-xl p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold text-slate-900 mb-3">2. Effective for Treatment-Resistant Anxiety</h3>
                  <p className="text-sm md:text-base text-slate-700">
                ...
                <div className="bg-green-50 rounded-xl p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold text-slate-900 mb-3">3. Can Be Combined with Other Treatments</h3>
                  <p className="text-sm md:text-base text-slate-700">
                ...
                <div className="bg-yellow-50 rounded-xl p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold text-slate-900 mb-3">4. Lasting Results</h3>
                  <p className="text-sm md:text-base text-slate-700">
            ...
            {/* Treatment Outcomes */}
            <section className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">Treatment Outcomes: What Veterans Can Expect</h2>
              <p className="text-base md:text-lg text-slate-700 leading-relaxed mb-6">
                Clinical studies and real-world outcomes demonstrate the effectiveness of TMS for anxiety in veterans:
              </p>
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-6 md:p-8 mb-6">
                <h3 className="text-xl md:text-2xl font-bold text-slate-900 mb-6">Clinical Evidence:</h3>
                <div className="grid sm:grid-cols-3 gap-4 md:gap-6">
                  <div className="text-center">
                    <div className="text-3xl md:text-4xl font-bold text-purple-600 mb-2">60-70%</div>
                    <p className="text-sm md:text-base text-slate-700">of patients show significant anxiety reduction</p>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">50%+</div>
                    <p className="text-sm md:text-base text-slate-700">achieve remission of anxiety symptoms</p>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl md:text-4xl font-bold text-green-600 mb-2">3-4 weeks</div>
                    <p className="text-sm md:text-base text-slate-700">typical timeframe to notice improvements</p>
                  </div>
                </div>
              </div>
              <div className="bg-slate-50 border-l-4 border-purple-500 p-4 md:p-6 rounded-lg">
                <h4 className="text-lg md:text-xl font-bold text-slate-900 mb-3">What Veterans Report:</h4>
                <ul className="list-disc pl-5 md:pl-6 text-sm md:text-base text-slate-700 space-y-2">
            ...
            <section className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">Is TMS Right for Your Anxiety?</h2>
              <p className="text-base md:text-lg text-slate-700 leading-relaxed mb-6">
                TMS may be an excellent option for veterans with anxiety who:
              </p>
              <div className="space-y-2 md:space-y-3 mb-6">
                <div className="flex items-start gap-3 bg-slate-50 p-3 md:p-4 rounded-lg">
                  <span className="text-green-500 text-lg md:text-xl">✓</span>
                  <p className="text-sm md:text-base text-slate-700">Haven't responded adequately to medications</p>
                </div>
                <div className="flex items-start gap-3 bg-slate-50 p-3 md:p-4 rounded-lg">
                  <span className="text-green-500 text-lg md:text-xl">✓</span>
                  <p className="text-sm md:text-base text-slate-700">Experience significant side effects from anxiety medications</p>
                </div>
                <div className="flex items-start gap-3 bg-slate-50 p-3 md:p-4 rounded-lg">
                  <span className="text-green-500 text-lg md:text-xl">✓</span>
                  <p className="text-sm md:text-base text-slate-700">Want to reduce or eliminate medication use</p>
                </div>
                <div className="flex items-start gap-3 bg-slate-50 p-3 md:p-4 rounded-lg">
                  <span className="text-green-500 text-lg md:text-xl">✓</span>
                  <p className="text-sm md:text-base text-slate-700">Are committed to a 4-6 week treatment course</p>
                </div>
                <div className="flex items-start gap-3 bg-slate-50 p-3 md:p-4 rounded-lg">
                  <span className="text-green-500 text-lg md:text-xl">✓</span>
                  <p className="text-sm md:text-base text-slate-700">Prefer non-invasive, medication-free treatment options</p>
                </div>
              </div>
            </section>
            ...
            {/* Getting Started */}
            <section className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">Getting Started with TMS for Anxiety</h2>
              <div className="bg-purple-50 rounded-xl p-6 md:p-8">
                <h3 className="text-lg md:text-xl font-bold text-slate-900 mb-4">The Process at Karma TMS:</h3>
                <ol className="space-y-3 md:space-y-4 text-sm md:text-base text-slate-700">
            ...
            {/* Conclusion */}
            <section className="mb-12">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-6">A New Path Forward for Veterans with Anxiety</h2>
              <p className="text-base md:text-lg text-slate-700 leading-relaxed mb-6">
            ...
            <section className="mb-12">
              ...
              <div className="grid sm:grid-cols-2 gap-3 md:gap-4">
                <Link to="/blogs/understanding-ptsd-veterans" className="p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                  ...
                  <p className="text-xs md:text-sm text-slate-600">Learn about PTSD signs, symptoms, and treatment paths for veterans.</p>
                </Link>
                <Link to="/blogs/va-veterans-ptsd-tms" className="p-4 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors">
                  <h4 className="text-sm md:text-base font-semibold text-purple-600 mb-2">VA Approves TMS for Veterans</h4>
                  <p className="text-xs md:text-sm text-slate-600">Discover how to access TMS therapy through VA benefits.</p>
                </Link>
              </div>
            </section>
