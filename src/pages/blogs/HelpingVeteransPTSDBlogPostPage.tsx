        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <article className="lg:col-span-3 prose prose-lg max-w-none">
            ...
            <AuthorBox
              ...
              bio="Dr. Apollo Thomas is a board-certified psychiatrist with deep expertise in treating veteran PTSD through innovative approaches including TMS therapy. He has dedicated his career to serving those who served, providing compassionate, evidence-based care that honors military culture while delivering cutting-edge treatment."
