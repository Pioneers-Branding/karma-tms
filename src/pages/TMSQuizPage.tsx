    ...
    <div className="min-h-screen">
      ...
      <div className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <form
            acceptCharset="UTF-8"
            action="https://app.formester.com/forms/NXlBvsLlW/submissions"
            method="POST"
            ...
            <Card>
                ...
                <CardContent>
                  ...
                  <div key={option.value} className="flex items-start space-x-3">
                      ...
                      name={`quiz-${quizQuestions[currentStep].name}`}
                      value={option.value}
                      checked={
                      formData[quizQuestions[currentStep].name as keyof typeof formData] === option.value
                      }
                      onChange={(e) =>
                      handleQuizAnswerChange(quizQuestions[currentStep].name, e.target.value)
                      }
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        className="text-sm text-gray-700 cursor-pointer leading-relaxed font-normal">
                          ...
                          I understand that I will receive emails and calls from the Karma team after submitting
                          this form. My data will be used for communication purposes only.{' '}
