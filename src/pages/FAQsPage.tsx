          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            ...
            <Card key={video.id} className="group cursor-pointer hover:shadow-lg transition-all duration-300 bg-white">
                <CardContent className="p-0">
                  ...
                  <div className="p-4">
                    <h3 className="font-semibold text-gray-900 leading-tight mb-2 group-hover:text-blue-600 transition-colors">
                      {video.title}
                    </h3>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-blue-100 mb-6">
              Our team is here to help. Schedule a consultation to discuss your specific situation 
              and learn how TMS therapy can help you.
            </p>
