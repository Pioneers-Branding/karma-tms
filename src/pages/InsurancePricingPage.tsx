...
const InsurancePricingPage = () => {
  ...
  { name: "  Medicare", coverage: "TMS for qualifying conditions", copay: "20% coinsurance", logo: "https://images.unsplash.com/photo-1551601651-2a8555f1a136?w=80&h=40&fit=crop" }];
