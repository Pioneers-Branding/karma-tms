    ...
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="bg-white/20 text-white mb-4">
                Women's Mood Treatment
              </Badge>
              <h1 className="text-4xl lg:text-5xl font-bold mb-6">
                TMS Therapy for Women's Mood Disorders
              </h1>
              <p className="text-xl text-white/90 mb-8">
                Specialized, safe treatment for women's unique mental health
                needs including postpartum depression, perinatal mood disorders,
                and hormone-related mood conditions.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link to="/tms-quiz">
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-white text-white hover:bg-white hover:text-[#572670] bg-black text-white"
                  >
                    Take Assessment
                  </Button>
                </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                Women's mood disorders encompass a range of mental health
                conditions that are influenced by hormonal changes, reproductive
                events, and unique biological factors. These conditions can
                occur during pregnancy, postpartum, menstrual cycles, or
                menopause and significantly impact emotional well-being and
                daily functioning.
              </p>
                ...
                {[
                  {
                    ...
                    desc: "Mood changes after childbirth affecting mother-infant bonding",
                  },
                  {
                    type: "Perinatal Mood Disorders",
                    desc: "Depression and anxiety during pregnancy and after delivery",
                  },
                  {
                    type: "Premenstrual Dysphoric Disorder (PMDD)",
                    desc: "Severe mood symptoms before menstruation",
                  },
                  {
                    type: "Perimenopausal Depression",
                    desc: "Mood changes during menopausal transition",
                  },
                ].map((item, index) => (
          ...
          <Card className="border-[#572670]/20 shadow-lg">
            <CardContent className="p-12">
              ...
              <p className="text-lg text-gray-700 mb-8">
                Take our confidential assessment to explore whether TMS therapy
                could provide the relief you need during this important time in
                your life.
              </p>
              <Link to="/tms-quiz">
                <Button
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Women experience unique mental health challenges influenced by
              hormonal fluctuations, reproductive life stages, and biological
              factors that require specialized understanding and care.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              TMS therapy offers a safe, non-medication approach to treating
              women's mood disorders, particularly beneficial during pregnancy,
              postpartum, and for those who want to avoid medications.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Research demonstrates TMS therapy's effectiveness for perinatal
              and postpartum depression, with studies showing significant
              improvement in maternal mood without adverse effects on fetal
              development or breastfeeding.
            </p>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-[#572670] mb-2">
                  Safe
                </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Our specialized approach to women's mood treatment is designed to
              support you through every stage of your journey with
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Expert Care for Women's Mental Health
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Our team specializes in women's mental health, understanding the
              unique challenges and providing compassionate, expert care
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="text-2xl font-bold text-[#572670]">
                          4-6 weeks
                        </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="bg-white rounded-lg p-8 text-center">
            ...
            <p className="text-lg text-gray-700 mb-6">
              You don't have to struggle alone. Our specialized women's mental
              health team is here to provide the compassionate, expert care you
              deserve during this important time.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-4">
            ...
            >
              ...
              <p className="text-sm text-gray-600">
                TMS therapy for major depression
              </p>
            </Link>
            <Link
              to="/anxiety"
