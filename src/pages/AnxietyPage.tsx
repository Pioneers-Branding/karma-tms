    ...
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8">
                Innovative, non-invasive treatment that targets the root causes
                of anxiety in the brain, offering lasting relief from persistent
                worry and fear.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                Anxiety disorders represent a group of mental health conditions
                characterized by excessive fear, worry, or nervousness that
                significantly impacts daily functioning. Unlike normal anxiety
                that everyone experiences, anxiety disorders involve persistent,
                overwhelming feelings that don't match the actual threat level
                of situations.
              </p>
              ...
              <div className="space-y-4 mb-8">
                {[
                  ...
                  {
                    type: "Panic Disorder",
                    symptoms: "Sudden panic attacks, heart palpitations",
                  },
                  {
                    type: "Social Anxiety",
                    symptoms: "Fear of social situations, avoidance behavior",
                  },
                  {
                    type: "Specific Phobias",
                    symptoms: "Intense fear of specific objects or situations",
                  },
                ].map((item, index) => (
          ...
          <Card className="border-purple-600/20 shadow-lg">
            <CardContent className="p-12">
              ...
              <p className="text-lg text-gray-700 mb-8">
                Our specialized anxiety assessment evaluates your symptoms and
                treatment history to determine if TMS therapy could provide the
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              TMS therapy for anxiety targets specific brain regions responsible
              for fear processing and emotional regulation, helping to reduce
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Emerging research demonstrates TMS therapy's effectiveness for
              various anxiety disorders, with many patients experiencing
              significant symptom reduction when traditional treatments haven't
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose Karma TMS for Anxiety Treatment?
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Our specialized approach to anxiety treatment combines
              evidence-based protocols with personalized care to address your
              unique anxiety symptoms and triggers.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">
                Benefits of TMS for Anxiety Disorders
              </h2>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Our anxiety-focused treatment approach is designed to help you
              feel comfortable and informed while targeting the specific neural
              circuits involved in your anxiety symptoms.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg p-8 text-center">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Don't let anxiety control your life. Discover how TMS therapy can
              help you regain confidence and peace of mind with our specialized
      ...
      <section className="py-12 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-center mb-8">
            Related Karma Mental Health Services
          </h2>
