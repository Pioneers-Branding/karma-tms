...
const TwentyNinePalmsPage = () => {
  const treatments = [
    {
      name: "TMS Therapy",
      desc: "FDA-approved treatment for depression and PTSD",
    },
    {
      name: "PR-TMS",
      desc: "Personalized protocol for military mental health",
    },
    ...
    { name: "PTSD Treatment", desc: "Specialized care for combat trauma" },
    {
      ...
      desc: "Expert psychiatric medication monitoring",
    },
    {
      ...
      <div className="relative bg-gradient-to-br from-purple-900 via-purple-800 to-purple-700 text-white py-24 lg:py-32">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-xl lg:text-2xl text-purple-100 max-w-3xl mb-8">
            Specialized mental health treatment for military families and the
            High Desert community - PTSD, depression, and anxiety care
          </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold mb-6">
                Serving the High Desert & Military Community
              </h2>
              <p className="text-xl text-gray-700 leading-relaxed max-w-4xl mx-auto">
                KarmaTMS Twentynine Palms is proud to serve active duty
                military, veterans, and families from Marine Corps Air Ground
                Combat Center and throughout the Morongo Basin.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
              <div>
                <h3 className="text-2xl font-bold mb-4">
                  Why Military Families Choose KarmaTMS
                </h3>
                <p className="text-lg text-gray-700 mb-4">
                  Located conveniently on 29 Palms Highway, our facility
                  provides easy access for those stationed at MCAGCC and
                  residents throughout the High Desert. We understand the unique
                  mental health challenges faced by military personnel and their
                  families.
                </p>
                <p className="text-lg text-gray-700 mb-6">
                  Our team has specialized experience treating{" "}
                  <Link
                    to="/conditions/ptsd"
                  ...
                  common among service members. We accept Tricare and work
                  seamlessly with military insurance.
                </p>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-700">
                Comprehensive, evidence-based treatments designed for service
                members
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 text-left mt-12">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">
                    Military-Focused Care
                  </h3>
                  <p className="text-gray-700">
                    Our team specializes in treating service members and{" "}
                    <Link
                      to="/veterans"
                      className="text-purple-600 hover:underline"
                    >
                    ...
                    and the challenges of active duty life.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    ...
                    <Link
                      ...
                      className="text-purple-600 hover:underline"
                    >
                      Tricare authorization and paperwork
                    </Link>{" "}
                    to make your care seamless and stress-free.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Proven success treating combat trauma, PTSD, and
                    deployment-related mental health conditions with TMS
                    therapy.
                  </p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">
                    Easy access from MCAGCC and throughout the High Desert with
                    ample parking and flexible scheduling.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="py-20 bg-gradient-to-br from-purple-900 via-purple-800 to-purple-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-purple-100 mb-10 max-w-2xl mx-auto">
            If you're a service member, veteran, or military family member
            struggling with PTSD, depression, or anxiety, we're here to help.
