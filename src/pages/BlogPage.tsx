...
const allBlogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1764569002/34_g1u7jn.png",
    featured: false,
    rating: 5,
  },
  {
  ...
  },
  {
    ...
    excerpt:
      "Comprehensive guide to ADHD treatment including medication, behavioral therapy, CBT, and lifestyle modifications. Learn how effective ADHD management works.",
    category: "mental-health",
    author: "Dr. Keerthy Sunder",
  ...
  },
  {
    ...
    excerpt:
      "A comprehensive analysis of suicide risk factors, prevention strategies, and mental health interventions for elderly populations.",
    category: "tms-therapy",
    author: "karmatmsdev",
    ...
    readTime: "15 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1764138579/30_lx4lub.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Discover how psychiatrists provide comprehensive mental health care through evidence-based treatments, personalized approaches, and innovative therapies like TMS.",
    category: "tms-therapy",
    author: "karmatmsdev",
    ...
    readTime: "12 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1764138578/31_n1knmb.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Comprehensive guide to TMS therapy as an effective treatment for treatment-resistant depression, including success rates, benefits, and what to expect.",
    category: "tms-therapy",
    author: "karmatmsdev",
  ...
  },
  {
    ...
    excerpt:
      "Addressing mental health access challenges in rural areas. Discover innovative solutions, telehealth options, and resources for improving mental healthcare.",
    category: "tms-therapy",
    author: "karmatms",
    ...
    readTime: "14 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1764138578/27_mpunrs.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Understanding how social media affects mental health. Learn about negative effects, warning signs, and strategies for healthier social media habits.",
    category: "tms-therapy",
    author: "karmatmsdev",
  ...
  },
  {
    ...
    excerpt:
      "Comprehensive guide on the most common reasons people seek therapy, from depression and anxiety to personal growth. Learn when to seek help.",
    category: "tms-therapy",
    author: "karmatmsdev",
    ...
    readTime: "15 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1764138578/29_xocrto.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Explore the bidirectional relationship between depression and erectile dysfunction. Learn about biological factors, psychological impact, and comprehensive treatment options.",
    category: "mental-health",
    author: "karmatmsdev",
    ...
    readTime: "15 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1764138577/24_guuewg.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Learn effective strategies for building trust and fostering open communication about mental health with teenagers. Recognize warning signs and create a supportive environment.",
    category: "mental-health",
    author: "karmatmsdev",
    ...
    readTime: "14 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1764138577/25_sumod0.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Comprehensive guide on understanding trauma, accessing mental health resources, and building resilience after exposure to community violence.",
    category: "mental-health",
    author: "karmatmsdev",
    ...
    readTime: "16 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1764138577/26_yez4z4.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Discover proven strategies for building emotional resilience in young people. Learn practical tools and techniques to help youth develop mental wellness.",
    category: "mental-health",
    author: "karmatms",
    ...
    readTime: "10 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1763376734/20_xdad6g.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Discover how family relationships and dynamics influence mental health outcomes and recovery processes. Learn strategies for creating supportive family environments.",
    category: "mental-health",
    author: "karmatms",
    ...
    readTime: "12 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1763376735/21_tyzclt.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Learn practical strategies to identify and manage anxiety triggers effectively in your daily routine. Master techniques for lasting anxiety relief.",
    category: "mental-health",
    author: "karmatms",
    ...
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1763376737/22_wiizht.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    readTime: "12 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1763036078/0_zutd9g.png",
    featured: true,
    rating: 5,
  },
  {
    ...
    readTime: "12 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1763376733/10_ha447l.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Understand why TMS therapy requires multiple sessions for lasting results. Learn about neuroplasticity, treatment protocols, and what to expect during your TMS journey.",
    category: "tms-therapy",
    author: "Dr. Keerthy Sunder",
  ...
  },
  {
    ...
    excerpt:
      "Discover the 4 A's of stress management: Avoid, Alter, Adapt, and Accept. Learn practical, evidence-based strategies to reduce stress and improve your mental health.",
    category: "wellness",
    author: "Dr. Keerthy Sunder",
  ...
  },
  {
    ...
    excerpt:
      "Explore the long-term effectiveness of TMS therapy and understand how this innovative treatment can provide lasting relief from depression and other mental health conditions.",
    category: "tms-therapy",
  ...
  },
  {
    ...
    excerpt:
      "Learn about the scientific evidence and FDA approval behind TMS therapy, and discover why it has become a trusted treatment for depression and mental health conditions.",
    category: "tms-therapy",
    author: "KarmatmsAdmin",
  ...
  },
  {
    ...
    excerpt:
      "Discover the success rates of TMS treatment based on clinical research and real patient outcomes. Learn what factors contribute to effective TMS therapy results.",
    category: "tms-therapy",
    author: "KarmatmsAdmin",
  ...
  },
  {
    ...
    excerpt:
      "Understand how excessive screen time affects mental health and well-being. Learn practical strategies to balance digital life with mental wellness.",
    category: "mental-health",
    author: "karmatms",
  ...
  },
  {
    ...
    excerpt:
      "Discover evidence-based mindfulness practices for stress management. Learn meditation techniques, breathing exercises, and daily practices to reduce anxiety.",
    category: "wellness",
    author: "karmatms",
    ...
    readTime: "12 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1763376734/17_dnhevc.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Explore how technology affects mental health—both positively and negatively. Learn about social media impacts and digital wellbeing strategies.",
    category: "mental-health",
    author: "karmatms",
  ...
  },
  {
    ...
    excerpt:
      "Learn essential mental health first aid skills. Recognize crisis signs, provide immediate support, and connect people to professional help.",
    category: "mental-health",
    author: "karmatms",
  ...
  },
  {
    ...
    excerpt:
      "Educational guide explaining the relationship between VA programs and TMS therapy, and how veterans can access care through VA-approved or private options.",
    category: "mental-health",
    author: "Dr. Keerthy Sunder",
    ...
    readTime: "15 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1763033664/1_w61pyl.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Complete guide to obtaining VA disability benefits for mental health conditions. Learn about eligibility, rating percentages, application process, and how much the VA pays.",
    category: "mental-health",
    author: "Dr. Keerthy Sunder",
    ...
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1763033665/2_tv5b86.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Comprehensive comparison of TMS therapy and medication for veterans with depression. Discover why veterans are choosing magnetic stimulation over traditional antidepressants.",
    category: "tms-therapy",
    author: "Dr. Keerthy Sunder",
    ...
    readTime: "16 min read",
    image:
      "https://res.cloudinary.com/de4kw1t2i/image/upload/v1763033665/3_zl830g.png",
    featured: false,
    rating: 5,
  },
  {
    ...
    excerpt:
      "Compassionate guide for helping veterans with PTSD, including therapy options, TMS treatment, local resources, and support strategies for families.",
    category: "mental-health",
    author: "Dr. Keerthy Sunder",
  ...
  },
  {
    ...
    excerpt:
      "A comprehensive guide to recognizing PTSD in war veterans and Vietnam vets, with modern treatment options including TMS therapy.",
    category: "mental-health",
    author: "Dr. Keerthy Sunder",
  ...
  },
  {
    ...
    excerpt:
      "Discover how TMS therapy helps veterans manage anxiety through brain regulation, offering hope beyond traditional medications.",
    category: "tms-therapy",
    author: "Dr. Keerthy Sunder",
  ...
  },
  {
    ...
    excerpt:
      "Learn how TMS addresses chronic migraines in veterans, including comorbidity with PTSD and depression, plus VA disability information.",
    category: "tms-therapy",
    author: "Dr. Keerthy Sunder",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-5xl font-bold text-gray-900 mb-4">
              Mental Health{" "}
              <span className="bg-gradient-to-r from-[#572670] via-[#7B4D9E] to-[#572670] bg-clip-text text-transparent">
                Insights
              </span>
            </h1>
              ...
              <div className="grid lg:grid-cols-2 gap-0">
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  <Button
                    asChild
                    variant="secondary"
                    className="w-fit bg-white text-[#572670] hover:bg-gray-50"
                  >
              ...
              >
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                  {regularPosts.map((post, index) => {
                    ...
                    return (
                      <a key={post.id} href={postLinks[post.id] || "/blog"}>
                          ...
                          <CardContent className="pt-2">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <Button
                                variant="ghost"
                                size="sm"
                                className="text-[#572670] hover:text-[#572670]/80 p-0"
                              >
                                Read More{" "}
