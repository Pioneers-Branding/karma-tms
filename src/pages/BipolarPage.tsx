    ...
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8">
                Specialized treatment approach for the depressive episodes of
                bipolar disorder, offering hope for mood stabilization when
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                Bipolar depression refers to the depressive episodes experienced
                by individuals with bipolar disorder. These episodes can be
                particularly challenging because they often don't respond as
                well to traditional antidepressants and may require specialized
                treatment approaches to avoid triggering manic episodes.
              </p>
          ...
          <Card className="border-purple-600/20 shadow-lg">
            <CardContent className="p-12">
              ...
              <p className="text-lg text-gray-700 mb-8">
                Take our specialized bipolar assessment to see if TMS therapy
                could help manage your depressive episodes while maintaining
                mood stability.
              </p>
              <Link to="/tms-quiz">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              TMS for bipolar depression requires specialized protocols to treat
              depressive symptoms while minimizing the risk of inducing mania,
              making it a valuable option for this complex condition.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 mb-6">
              TMS for bipolar depression requires specialized expertise and
              careful monitoring. Treatment protocols are modified to reduce the
              risk of switching to mania while effectively treating depressive
              symptoms. Close collaboration with your psychiatrist is essential.
            </p>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose Karma TMS for Bipolar Depression?
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Managing bipolar depression requires specialized knowledge and
              careful treatment protocols. Our team has the expertise to provide
              safe, effective TMS treatment for bipolar patients.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              What to Expect During Bipolar Treatment
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Our specialized approach to bipolar depression ensures safety
              while maximizing the therapeutic benefits of TMS treatment for
          ...
          <div className="bg-white rounded-lg p-8 text-center">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Don't let bipolar depression control your life. Discover how
              specialized TMS treatment can help you achieve better mood
