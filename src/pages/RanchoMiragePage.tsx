            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-12">
              <div>
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Our Rancho Mirage location combines cutting-edge <Link to="/tms-therapy" className="text-purple-600 hover:underline">TMS therapy technology</Link> with personalized, concierge-level care. We understand that mental health treatment requires privacy, comfort, and expertise.
                </p>
                <p className="text-lg text-gray-700 mb-6">
                  Whether you're dealing with <Link to="/depression" className="text-purple-600 hover:underline">treatment-resistant depression</Link>, <Link to="/anxiety" className="text-purple-600 hover:underline">anxiety disorders</Link>, or other mental health challenges, our experienced team provides compassionate, evidence-based care in a luxurious, discrete environment.
                </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 text-left mt-12">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700"><Link to="/team" className="text-purple-600 hover:underline">Board-certified psychiatrists</Link> with extensive experience in TMS therapy and treatment-resistant conditions.</p>
                </div>
              </div>
              <div className="flex gap-4">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700">Integrated approach combining TMS, <Link to="/medication-management" className="text-purple-600 hover:underline">medication management</Link>, and therapeutic support.</p>
                </div>
              </div>
            </div>
          </div>
