    ...
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8">
                FDA-approved, non-invasive treatment that offers new hope for
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                Depression is more than just feeling sad or going through a
                rough patch. It's a serious mental health condition that affects
                how you feel, think, and handle daily activities. Major
                depressive disorder impacts millions of people worldwide and can
                significantly interfere with work, relationships, and overall
                quality of life.
              </p>
          ...
          <Card className="border-purple-600/20 shadow-lg">
            <CardContent className="p-12">
              ...
              <p className="text-lg text-gray-700 mb-8">
                Take our comprehensive assessment to determine if you're a
                candidate for TMS therapy. This confidential evaluation takes
                just 5 minutes and can be the first step toward recovery.
              </p>
              <Link to="/tms-quiz">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              ...
              pulses to stimulate specific areas of the brain associated with
              mood regulation, offering hope where traditional treatments may
              have failed.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 mb-6">
              TMS therapy has been extensively studied and proven effective for
              depression treatment. Clinical trials show that approximately
              60-70% of patients with treatment-resistant depression experience
              significant improvement with TMS therapy.
            </p>
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose Karma TMS for Depression Treatment?
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Our specialized approach combines cutting-edge technology with
              compassionate care, tailored specifically for your unique
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Our comprehensive approach ensures you feel informed, comfortable,
              and supported throughout your TMS journey.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg p-8 text-center">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Take the first step toward overcoming depression with TMS therapy
              at Karma TMS. Our compassionate team is here to support you every
              step of the way.
            </p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-center mb-8">
            Explore More KarmaTMS Services
          </h2>
          <div className="grid md:grid-cols-4 gap-4">
            ...
            >
              ...
              <p className="text-sm text-gray-600">
                Visit our Coachella Valley center
              </p>
            </Link>
            <Link
              to="/contact"
