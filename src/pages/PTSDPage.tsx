    ...
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8">
                Compassionate, evidence-based treatment that helps heal trauma's
                impact on the brain, offering new hope for recovery from
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                ...
                event. It affects millions of people, including veterans, first
                responders, accident survivors, and those who have experienced
                abuse, violence, or other life-threatening situations.
              </p>
                ...
                {[
                  {
                    ...
                    symptoms: "Flashbacks, nightmares, intrusive memories",
                  },
                  {
                    category: "Avoidance",
                    symptoms: "Avoiding triggers, places, people, or thoughts",
                  },
                  {
                    category: "Negative Changes",
                    symptoms: "Negative thoughts, mood, and beliefs",
                  },
                  {
                    category: "Hyperarousal",
                    symptoms: "Hypervigilance, irritability, sleep problems",
                  },
                ].map((item, index) => (
              ...
              <p className="text-gray-700">
                PTSD is not a sign of weakness - it's a natural response to
                abnormal situations. With proper treatment, recovery is
                possible.
              </p>
            </div>
            <div className="relative">
          ...
          <Card className="border-purple-600/20 shadow-lg">
            <CardContent className="p-12">
              ...
              <p className="text-lg text-gray-700 mb-8">
                Take our confidential PTSD assessment to explore if TMS therapy
                could be part of your healing journey. You deserve to live free
                from trauma's grip.
              </p>
              <Link to="/tms-quiz">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              TMS therapy for PTSD targets brain regions affected by trauma,
              helping to restore normal functioning and reduce the hyperactivity
              in areas responsible for fear responses and emotional regulation.
            </p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8">
            ...
            <p className="text-lg text-gray-700 mb-6">
              While TMS for PTSD is still being researched, preliminary studies
              show promising results for veterans and civilians with
              treatment-resistant PTSD. Research indicates improvements in
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose Karma TMS for PTSD Treatment?
            </h2>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              We understand that PTSD treatment requires special sensitivity and
              expertise. Our team is trained to provide trauma-informed care in
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              We understand that seeking treatment for PTSD takes courage. Our
              process is designed to ensure you feel safe, informed, and
          ...
          <div className="bg-white rounded-lg p-8 text-center">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Healing from trauma is possible. Take the first step toward
              reclaiming your life with compassionate, evidence-based TMS
              treatment for PTSD.
            </p>
