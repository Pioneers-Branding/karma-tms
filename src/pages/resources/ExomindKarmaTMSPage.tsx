      ...
      <section className="py-16 px-4 bg-gradient-to-br from-purple-50 to-indigo-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <img
                src="https://res.cloudinary.com/de4kw1t2i/image/upload/v1766992546/IMG_5821_cud7cg.jpg"
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div>
                      ...
                      <a href="tel:760-760-5675" className="text-[#4e4e4e] font-medium text-base hover:underline">
                        (760) 760-5675
                      </a>
                    </div>
                  </div>
