          ...
          <Tabs value={reportStep.toString()} onValueChange={(value) => setReportStep(parseInt(value))}>
            <TabsList className="grid grid-cols-5 w-full mb-8 bg-gradient-to-r from-[#572670]/10 to-purple-600/10">
              ...
              <TabsTrigger
                ...
                className="data-[state=active]:bg-gradient-to-r data-[state=active]:from-[#572670] data-[state=active]:to-purple-600 data-[state=active]:text-white bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373] bg-white text-[#737373]">
