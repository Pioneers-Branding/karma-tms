        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="relative">
                ...
                <CardContent className="p-0">
                  <div className="aspect-[4/5] relative bg-gradient-to-br from-[#572670]/10 to-purple-100/20">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 bg-white/80 backdrop-blur-md p-8 border-t border-white/20">
                      ...
                      <p className="text-[#572670] font-semibold text-lg">
              ...
              <Card className="absolute -bottom-12 -left-8 bg-white shadow-xl border-2 border-[#572670]/20 lg:block hidden">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                ...
                psychiatry, leading our team of mental health providers in Palm
                Springs, CA, to provide exceptional, patient-centered care. His
                philosophy focuses on treating the whole person not just the
                symptoms through compassionate, evidence-based care at our
                mental health facilities in Palm Springs.
              </p>
              ...
              <div className="p-6 bg-gradient-to-r from-[#572670]/5 to-purple-100/20 rounded-2xl border-l-4 border-[#572670]">
                <blockquote className="text-xl text-[#572670] font-medium italic">
                  "Integrative psychiatry combining mind and brain
                  electrophysiology for optimal mental wellness."
                </blockquote>
              </div>
            </div>
