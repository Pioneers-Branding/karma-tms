...
const WhyChooseKarmaSection = () => {
  const commitmentSections = [
  {
    ...
    description: "Our expert mental health counselors in Palm Springs design a unique TMS therapy plan tailored to your specific needs, ensuring the most effective treatment for mental health in Palm Springs.",
  ...
  },
  {
    ...
    image: "https://res.cloudinary.com/de4kw1t2i/image/upload/v1761742435/IMG_5128_fci7xz.jpg",
    overlay: true
  }];
