      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            Our mental health facilities in Palm Springs are conveniently
            located serving patients throughout the Coachella Valley and
            surrounding areas, with experienced mental health counselors in Palm
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-stretch">
          ...
          <Card className="shadow-xl border-0 flex flex-col justify-between">
            <CardContent className="p-8 flex flex-col h-full">
                ...
                >
                  ...
                  <div>
                    ...
                    {href ? (
                      <a
                        href={href}
                        className="font-medium text-[#707070] hover:underline whitespace-pre-line"
                      >
                        {value}
                      </a>
                    ) : (
              ...
              <div className="mt-auto flex flex-col sm:flex-row gap-4 pt-4 border-t border-gray-200">
                <Button
                  asChild
                  className="bg-[#572670] hover:bg-[#572670]/90 text-white px-8 flex items-center gap-2 justify-center"
                >
          ...
          <div className="flex flex-col gap-6 h-full">
            {[
              ...
              <Card
                key={idx}
                className="shadow-xl border-0 flex-grow overflow-hidden rounded-lg"
              >
