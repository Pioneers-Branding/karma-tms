...
import { MapPin, Mail, Phone, Calendar, Award, Stethoscope, User, ChevronRight, Languages } from 'lucide-react';
              ...
              <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                ...
                <div className="space-y-6 mt-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
                        <Languages size={18} className="text-[#572670]" />
                        Languages
                      </h4>
                  ...
                  <div>
                    ...
                    <Badge className={`bg-gradient-to-r ${categoryColors[member.category]} text-white`}>
                      {member.specialization}
                    </Badge>
                  </div>
